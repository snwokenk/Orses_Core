...
if __name__ == '__main__':
    print(SHA256.new(json.dumps({"W9d313a84e7d6e4191d4ff7b3aa50be43fe6ea8cb": 0.0}).encode()).hexdigest())
    # for tat in genesis_block["rwd_tx"]:
    #     print(tat)
    #     print(SHA256.new(json.dumps(tat).encode()).hexdigest())
    #     print("=" * 30)